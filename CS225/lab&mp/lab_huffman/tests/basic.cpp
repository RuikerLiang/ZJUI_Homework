...
TEST_CASE("aaaa", "[weight=1]") {
	encoder::encodeFile( "tests/a.txt", "tests/test.bin", "tests/tree.huff" );
}

TEST_CASE("aaaade", "[weight=1]") {
	decoder::decodeFile( "tests/a.txt", "tests/test.bin", "tests/tree.huff" );
}